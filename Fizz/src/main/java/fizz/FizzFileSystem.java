...
@FileSystemInfo(
		...
		factory = FizzFileSystem.MyFileSystemFactory.class)
public class FizzFileSystem implements GFileSystem {
	 ...
	 */
	public FizzFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + FizzFileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryFull<FizzFileSystem>, GFileSystemProbeFull {

		@Override
		public FizzFileSystem create(FSRL containerFSRL, FSRLRoot targetFSRL,
				ByteProvider byteProvider, File containerFile, FileSystemService fsService,
				TaskMonitor monitor) throws IOException, CancelledException {

			FizzFileSystem fs = new FizzFileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
